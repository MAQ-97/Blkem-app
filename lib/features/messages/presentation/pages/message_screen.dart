        ...
        child: CustomScrollView(
          slivers: [
            SliverAppBar(
                ...
                centerTitle: true,
                actions: [
                  ["Delete Messages","Report"].toPopUpMenuButton((value) { },icon: RotatedBox(
                      quarterTurns: 45,
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: ['Search for contacts...'
                      .toSearchBarField(fieldValidator: messageCubit.searchQuery)
