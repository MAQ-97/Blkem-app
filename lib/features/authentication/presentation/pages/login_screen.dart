...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget buildTopView() {
    return [
      ...
      [
        Strings.emailAddress.toTextField(icon: Images.email).toStreamBuilder(validators: loginCubit.emailValidators).toThemeTextField,
        10.toSizedBox,
       ...
       loginCubit.validForm.listen((event) {
        ...
        },icon: Images.lock).toStreamBuilder(validators: loginCubit.passwordValidator).toThemeTextField,
        5.toSizedBox,
        Strings.forgotPassword
            .toCaption(fontWeight: FontWeight.w600,color: AppColors.colorPrimary)
            .toContainer(alignment: Alignment.centerLeft)
            .toVerticalPadding(12.0).toHorizontalPadding(10)
            .onTap(() {
          ExtendedNavigator.root.push(Routes.resetPasswordScreen);
        }),
        "The email and password you entered does not match. Please double-check and try again".toCaption(color: Colors.red,fontWeight: FontWeight.w600).toAlign(TextAlign.center,).toVisibilityStreamBuilder(loginCubit.errorTextStream.stream)
      ].toColumn()
    ].toColumn(
    ...
    return [
      ...
      [
        ...
        Images.google
            .toSvg()
            .toFlatButton(
              () =>  loginCubit.googleLogin(),radius: 5,borderColor: Colors.grey.shade300
            )
            .toSizedBox(height: 40, width: 55)
            .toContainer(
      ...
      [
        ...
        Strings.byClickingAgree
            .toButton(fontSize: 14.0, color: AppColors.greyText)].toRow(crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.center),
      [
        Strings.termsOfUse
